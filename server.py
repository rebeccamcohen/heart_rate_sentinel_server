...
def get_new_patient():
    ...
    patient = User(patient_id=r["patient_id"], attending_email=r["attending_email"], user_age=r["user_age"])
    patient.save()

    result = {
       "message": "Added patient successfully to the database".format(request.json["patient_id"]),
    }
